...
var _viewsSingleview = require('./views/singleview');

var _viewsSingleview2 = _interopRequireDefault(_viewsSingleview);

var _viewsNewContact = require('./views/newContact');

var _viewsNewContact2 = _interopRequireDefault(_viewsNewContact);
...
var Router = _backbone2['default'].Router.extend({
	...
	initialize: function initialize(x) {
		this.$el = x;
	...
	home: function home() {
		this.contacts.fetch().then((function () {
			this.$el.html((0, _viewsHome2['default'])(this.contacts.toJSON()));
		}).bind(this));
	},

	showSingleContact: function showSingleContact(contactId) {
		var _this = this;
		...
		if (contact) {
			...
			(function () {
				...
				contact.fetch().then(function () {
					router.$el.html((0, _viewsSingleview2['default'])(contact.toJSON()));
				});
			})();
		}
...
},{"./contacts_collection":2,"./views/home":6,"./views/newContact":7,"./views/singleview":8,"backbone":9,"jQuery":10}],6:[function(require,module,exports){
'use strict';
